...
function [r_chaser_leg1,r_chaser_leg2,totalAccel] = RotDockingCost(r_w,v_w,tof_w,tof)
...
[t,state_array] = ode113('ZEM_ZEV_prop_waypoint',time_array_waypoint,state_array0);
...
[t,state_array] = ode113('ZEM_ZEV_prop',time_array_final,state_array0);
